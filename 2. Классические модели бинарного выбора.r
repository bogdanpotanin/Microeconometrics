...
is_female <- (h$male == 0)
mean_female <- data.frame("skills" = mean(h$skills[is_female]),         # укажем характеристики
                          "male" = 0,                                   # Бориса в датафрейме
                          "experience" = mean(h$experience[is_female]),
                          "weight" = mean(h$weight[is_female]))
...
# шансов при изменении веса (weight) индивида на единицу
...
# 5.2*.   Постройте 95% бутстрапированный ДИ для
